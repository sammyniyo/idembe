        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Booking<span class="text-primary text-uppercase"> Success</span></h1>
                </div>
                <div class="row g-4 center">
                    <div class="col-lg-12 col-md-12 wow fadeInUp" data-wow-delay="0.6s">
                        <a class="service-item rounded" href="#">
                            ...
                            <p class="text-body mb-0">Thank you for bookinga room! we'll contact you via email or phone very soon.</p>
                        </a>
                    </div>
                </div>
            </div>
