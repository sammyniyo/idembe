...
<head>
    <meta charset="utf-8">
    <title>Idembe | Welcome To IDEMBE</title>
                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                <h6 class="section-title text-white text-uppercase mb-3 animated slideInDown">Hotel & Lodging</h6>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <p class="mb-4">Welcome to our hotel! We are delighted to have you as our guest and we will do everything we can to make your stay comfortable and enjoyable. 
                            Our hotel is a haven of luxury, with exceptional amenities, and impeccable service.</p>
...
<div class="container-xxl py-5">
  <div class="container">
    ...
    <a class="btn btn-primary py-3 px-5 mt-2" href="acommodation.php" style="float: right;">Explore More</a>
  </div>
</div>
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <a class="service-item rounded" href="">
                            ...
                            <p class="text-body mb-0">We offer a comfortable and convenient living space, making guests feel at home while traveling. With flexibility for short or long-term stays, 
                                these services provide a home-like experience with hotel amenities and services.</p>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                        <a class="service-item rounded" href="">
                            ...
                            <p class="text-body mb-0">We offer fresh, high-quality meals catering to different dietary preferences. From quick bites to fine dining experiences, 
                                these services strive to exceed guest expectations with memorable culinary experiences.</p>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <a class="service-item rounded" href="">
                            ...
                            <p class="text-body mb-0">We promote wellness and make it easy for guests to maintain their fitness routine while traveling. With a variety of options available, such as cardio, strength training, and group classes, 
                                guests can choose the activities that suit them best.</p>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                        <a class="service-item rounded" href="">
                            ...
                            <p class="text-body mb-0">We provide entertainment options for guests to enjoy, whether it's an outdoor activity or an indoor game. 
                                These services aim to make guests' stay enjoyable and engaging with something for everyone.</p>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <a class="service-item rounded" href="">
                            ...
                            <p class="text-body mb-0">We provide seamless event planning for weddings, conferences, and social gatherings. With assistance and coordination,
                                 these services aim to make each event successful and memorable.</p>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                        <a class="service-item rounded" href="">
                            ...
                            <p class="text-body mb-0">We promote health and wellness by offering guests various ways to stay active and de-stress, 
                                including state-of-the-art equipment and yoga classes for inner peace and balance.</p>
                        </a>
                    </div>
                </div>
            </div>
